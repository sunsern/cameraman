 ...
 *
 */
public class SkinIntegralImage {
	
	private final int nBin = SkinFeature.nBin;
	private int height, width, resizeFactor;
	private double[] ii; // [bin#][x][y]
        private int x1,y1,x2,y2;
  
	public SkinIntegralImage(double[] score, int w, int h, 
		...
		computeIntegralImage(score);
	}

        public SkinIntegralImage(double[] score, int w, int h, int resizeFactor) {
	...
	private void computeIntegralImage(double[] score) {
