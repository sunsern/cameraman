...
public class HsvSkinFeature extends AbstractFeature {
  ...
  //------------ Static Methods -----------//
	...
	public static double getSkinFeatureAtIndex(Candidate c, HsvSkinIntegralImage skinii, int index) {
	...
	public static double[] getSkinFeatureVector(Candidate c, HsvSkinIntegralImage skinii) {
