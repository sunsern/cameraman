...
public class HogFeature extends AbstractFeature {
	...
	public static double computeHOGFeatureAtIndex(Candidate c, HogIntegralImage ii, int index) {
	...
	public static double[] getHOGFeatureVector(Candidate c, HogIntegralImage ii) {		
