 ...
 *
 */
public class HsvSkinFeature extends AbstractFeature {

	public static final int nBin = 3; // H, S and V 
	public static final int nRegion = 16;
	public static final int nFeature = nRegion * nBin;
		
	public static final int TYPEID = 6;
	public static final String NAME = "hsvskin";
	public int hsvskinindex;
	
	public double getFeatureValue(HsvSkinCache cache) {
		return cache.getFeatureValue(hsvskinindex);
	}

	public boolean testCandidate(HsvSkinCache cache) {
		double v = cache.getFeatureValue(hsvskinindex);
		return v < this.getThreshold();
	}

  //------------ Static Methods -----------//
	
	public static double getSkinFeatureAtIndex(FaceCandidate c, HsvSkinIntegralImage skinii, int index) {
	...
	public static double[] getSkinFeatureVector(FaceCandidate c, HsvSkinIntegralImage skinii) {
