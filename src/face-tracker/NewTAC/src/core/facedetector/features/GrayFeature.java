 ...
 *
 */
public class GrayFeature extends AbstractFeature {
	...
	public double getFeatureValue(GrayCache cache) {
		return cache.getFeatureValue(grayindex);
	}

	public boolean testCandidate(GrayCache cache) {
	...
	public static double[] getGreyFeatureVector(FaceCandidate c, GrayIntegralImage ii) {
