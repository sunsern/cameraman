...
public class SkinFeature extends AbstractFeature {
  ...
  //------------ Static Methods -----------//
	...
	public static double getSkinFeatureAtIndex(FaceCandidate c, SkinIntegralImage skinii, int index) {
	...
	public static double[] getSkinFeatureVector(FaceCandidate c, SkinIntegralImage skinii) {
