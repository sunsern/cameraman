...
public class EyeFeature extends AbstractFeature {
	...
	public double getFeatureValue(FaceCandidate c, GrayIntegralImage ii) {
		return getEyeFeature(c, ii);
	}

	public boolean testCandidate(FaceCandidate c, GrayIntegralImage ii) {
	...
	public static double getEyeFeature(FaceCandidate c, GrayIntegralImage ii) {
